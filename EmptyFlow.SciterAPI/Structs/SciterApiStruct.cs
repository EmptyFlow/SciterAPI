...
namespace EmptyFlow.SciterAPI.Structs {
    ...
    public delegate bool SciterSetMediaVars ( IntPtr hwnd, ref SciterValue mediaVars );
    public delegate uint SciterGetMinWidth ( IntPtr hwnd );
    public delegate uint SciterGetMinHeight ( IntPtr hwnd, uint width );
    public delegate bool SciterCall ( IntPtr hwnd, [MarshalAs ( UnmanagedType.LPStr )] string functionName, uint argc, SciterValue[] argv, out SciterValue retval );
    public delegate bool SciterEval ( IntPtr hwnd, [MarshalAs ( UnmanagedType.LPWStr )] string script, uint scriptLength, out SciterValue pretval );
    ...
    public delegate bool SciterGetViewExpando ( IntPtr hwnd, out SciterValue pval );
    ...
    public delegate ValueResult ValueInvoke ( ref SciterValue pval, ref SciterValue pthis, uint argc, SciterValue[] argv, out SciterValue pretval, IntPtr url );
    ...
    public delegate ulong SciterAtomValue ( [MarshalAs ( UnmanagedType.LPStr )] string name );
